...
public class main {
    public static void main(String[] args) throws FileNotFoundException, ParseException {
        ...
        var library = new Library("C:\\Users\\lichn\\books.txt", "C:\\Users\\lichn\\abonements.txt");
        while (true){
            ...
            switch (num){
                ...
                case "3":
                    ...
                    System.out.println(library.GetReaderCountByAuthor(author) + "book(-s) written by " + author);
                    break;
                case "4":
